...
*   🏬 **Opérations Retail :** Channel Supervision, Gestion des Inventaires
*   📈 **Performance :** Design de KPIs, Benchmarking, Data Visualization

#### 🎛️ Électronique & Outils Dev
*   📟 **Matériel :** Électronique, Internet des Objets (IoT)
*   💻 **Environnement :** Git, GitHub, VS Code, Jupyter
